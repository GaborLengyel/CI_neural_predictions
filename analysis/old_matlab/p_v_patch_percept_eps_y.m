function [struct_samps_id] = p_v_patch_percept_eps_y(eps_target,eps_surround,model_params,n_trials)
...
[prs,sts]=p_struct_expand(model_params,o_target,o_surround);
