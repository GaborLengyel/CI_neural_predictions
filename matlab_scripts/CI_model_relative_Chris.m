function [neuron_resps_group,resps_group] = CI_model_relative_Chris( dir_c, dir_s,speed_c,speed_s,n_trials,subid,ndots,model_params,causalStruct,dirtun,speedtun,tunType)
