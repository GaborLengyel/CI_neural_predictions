...
neuronTypes = {{3, 0, 0.4, 0.1, 0.5913},...
               ...
               {3, 0, 8, 0.07, 0.1}};
men=0;
neuronTypes = {{3, men, 0.5, 1, 0.5913},...
                {3, men, 2, 1, 0.5913},...
                {3, men, 8, 1, 0.5913},...
                {3, men, 0.5, 0.3, 0.5913},...
                {3, men, 2, 0.3, 0.5913},...
                {3, men, 8, 0.3, 0.5913},...
                {3, men, 0.5, 0.1,0.5913},...
                {3, men, 2, 0.1, 0.5913},...
                {3, men, 8, 0.1, 0.5913}};
%%%%%%%%%% Model params %%%%
varType = 2;
...
%varfire = zeros(length(neuronTypes),endS-startS+1,len_s_speed,len_c_speed,len_s,len_c);
%meanfire = zeros(length(neuronTypes),lenS*lenV,lenNS,len_s_speed,len_c_speed,len_s,len_c);
...
%                 {-40, 0.9913},...
%                 };
% for m=1:length(meanTypes)
% m1= meanTypes{m}{1};
% m2=meanTypes{m}{2};
% neuronTypes = {{3, m1, 0.5, 1, m2},...
%                 {3, m1, 2, 1, m2},...
%                 {3, m1, 8, 1, m2},...
%                 {3, m1, 0.5, 0.3, m2},...
%                 {3, m1, 2, 0.3, m2},...
...
save('MF_cent_5subj.mat','meanfire',"-v7.3")
%save(['MF_3shift',num2str(m),'.mat'],'meanfire',"-v7.3")
